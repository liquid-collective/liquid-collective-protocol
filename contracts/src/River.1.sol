    ...
    IRiverV1
{
    ...
    /// @notice Overridden handler called after deposits to update operator funded balances
        ...
        override
    {
        ...
        for (uint256 i = 0; i < _deposits.length; ++i) {
            or_.reportFundedBalance(_deposits[i].operatorIndex, _deposits[i].depositAmount);
        }
    }
