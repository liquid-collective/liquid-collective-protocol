...
interface IConsolidationCoverageFundV1 {
    ...
    /// @notice A donation has been made to the consolidation coverage fund
    ...
    /// @notice Initialize the consolidation coverage fund with the required arguments
    /// @param _riverAddress Address of River
    function initConsolidationCoverageFundV1(address _riverAddress) external;
    ...
    /// @notice Donates ETH to the consolidation coverage fund contract
