...
contract BurnMintERC677 is IBurnMintERC20, ERC677, IERC165, ERC20BurnableUpgradeable, OwnableUpgradeable {
    ...
    function burn(uint256 amount) public override(IBurnMintERC20, ERC20BurnableUpgradeable) onlyBurner {
        super.burn(amount);
    }
