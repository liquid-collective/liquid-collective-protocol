...
contract ValidatorCredentialsProviderMock is IValidatorCredentialsProvider {
    ...
    {
        return (
            BytesLib.slice(publicKeys, 0, (amount > 10 ? 10 : amount) * 48),
            BytesLib.slice(signatures, 0, (amount > 10 ? 10 : amount) * 96)
        );
    }
}
...
contract DepositManagerV1Tests {
    ...
    IValidatorCredentialsProvider internal validatorCredentialsProvider;
    IDepositContract internal depositContract;

    function setUp() public {
        validatorCredentialsProvider = new ValidatorCredentialsProviderMock();
        ...
        DepositManagerV1ExposeInitializer(address(depositManager))
            .publicDepositManagerInitializeV1(
                ...
                address(validatorCredentialsProvider),
                withdrawalCredentials
            );
    }
...
contract ValidatorCredentialsProviderErrorMock is
    IValidatorCredentialsProvider
{
    bytes public publicKeys =
        hex"";
    bytes public signatures =
        ...
        returns (bytes memory, bytes memory)
    {
        if (scenario == 0) {
            ...
            return (
                BytesLib.slice(publicKeys, 0, 49),
                BytesLib.slice(signatures, 0, 96)
            );
        } else if (scenario == 2) {
            // invalid signature length
            return (
                BytesLib.slice(publicKeys, 0, 48),
                BytesLib.slice(signatures, 0, 97)
            );
        } else if (scenario == 3) {
            // no keys available
            ...
            // return 2 key sets
            return (
                BytesLib.slice(publicKeys, 0, 48 * 2),
                BytesLib.slice(signatures, 0, 96 * 2)
            );
        } else if (scenario == 5) {
...
contract DepositManagerV1ErrorTests {
    ...
    function setUp() public {
        validatorCredentialsProvider = new ValidatorCredentialsProviderErrorMock();
        depositContract = new DepositContractMock();
    ...
    function testInconsistentPublicKey() public {
        ...
        ValidatorCredentialsProviderErrorMock(
            address(validatorCredentialsProvider)
        ).setScenario(1);
