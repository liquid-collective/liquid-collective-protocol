...
contract OperatorsManagerV1MemberManagementTests {
    ...
    function testAddNodeOperator(
        ...
        vm.startPrank(admin);
        operatorsManager.addOperator(string(abi.encodePacked(_name)), _nodeOperatorAddress, _nodeOperatorFeeRecipient);
    ...
    function testAddValidatorsAsOperator(
        bytes32 _name,
        uint256 _firstAddressSalt,
        uint256 _firstFeeRecipientSalt
    ) public {
    ...
    function testAddValidatorsAsAdmin(
        bytes32 _name,
        uint256 _firstAddressSalt,
        uint256 _firstFeeRecipientSalt
    ) public {
    ...
    function testAddValidatorsAsUnauthorized(
        bytes32 _name,
        uint256 _firstAddressSalt,
        uint256 _firstFeeRecipientSalt
    ) public {
    ...
    function testAddValidatorsInvalidCount(
        bytes32 _name,
        uint256 _firstAddressSalt,
        uint256 _firstFeeRecipientSalt
    ) public {
    ...
    function testRemoveValidatorsAsOperator(
        bytes32 _name,
        uint256 _firstAddressSalt,
        uint256 _firstFeeRecipientSalt
    ) public {
    ...
    function testRemoveValidatorsAsAdmin(
        bytes32 _name,
        uint256 _firstAddressSalt,
        uint256 _firstFeeRecipientSalt
    ) public {
    ...
    function testRemoveValidatorsUnauthorized(
        bytes32 _name,
        uint256 _firstAddressSalt,
        uint256 _firstFeeRecipientSalt
    ) public {
    ...
    function testGetOperatorByName(
        bytes32 _name,
        uint256 _firstAddressSalt,
        uint256 _firstFeeRecipientSalt
    ) public {
    ...
    function testGetOperatorByIndex(
        bytes32 _name,
        uint256 _firstAddressSalt,
        uint256 _firstFeeRecipientSalt
    ) public {
