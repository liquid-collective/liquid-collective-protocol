...
import {BurnMintERC677} from "../src/token/BurnMintERC677.sol";
...
contract BurnMintERC677Setup is BaseTest {
    ...
    function setUp() public virtual override {
        BaseTest.setUp();
        s_burnMintERC677 = new BurnMintERC677();
        LibImplementationUnbricker.unbrick(vm, address(s_burnMintERC677));
        s_burnMintERC677.initialize("Chainlink Token", "LINK");
...
contract BurnMintERC677_constructor is BurnMintERC677Setup {
    function testConstructorSuccess() public {
        ...
        s_burnMintERC677 = new BurnMintERC677();
        LibImplementationUnbricker.unbrick(vm, address(s_burnMintERC677));
        s_burnMintERC677.initialize(name, symbol);
