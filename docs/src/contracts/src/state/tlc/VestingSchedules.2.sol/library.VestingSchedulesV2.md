# VestingSchedulesV2
[Git Source](https://github.com/liquid-collective/liquid-collective-protocol/blob/15c3aa6bd08000650f7da3ad4e5147502603ad9b/contracts/src/state/tlc/VestingSchedules.2.sol)
...
Storage slot of the Vesting Schedules (note the slot is different from v1)
...
### migrateVestingScheduleFromV1

Migrate a VestingSchedule from v1 to v2

Takes a VestingSchedule in v1 format in stores it in v2 format
...
|Name|Type|Description|
|----|----|-----------|
|`_index`|`uint256`|of the schedule in v1 to be migrated|
|`_releasedAmount`|`uint256`|The released amount to keep in storage|

**Returns**

|Name|Type|Description|
|----|----|-----------|
|`<none>`|`uint256`|The index of the created schedule in v2 format|
