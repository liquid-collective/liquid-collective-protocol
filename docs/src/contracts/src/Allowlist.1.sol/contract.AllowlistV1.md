# AllowlistV1
[Git Source](https://github.com/liquid-collective/liquid-collective-protocol/blob/15c3aa6bd08000650f7da3ad4e5147502603ad9b/contracts/src/Allowlist.1.sol)

**Inherits:**
[IAllowlistV1](/contracts/src/interfaces/IAllowlist.1.sol/interface.IAllowlistV1.md), [Initializable](/contracts/src/Initializable.sol/contract.Initializable.md), [Administrable](/contracts/src/Administrable.sol/abstract.Administrable.md), [IProtocolVersion](/contracts/src/interfaces/IProtocolVersion.sol/interface.IProtocolVersion.md)
...
All accounts have an uint256 value associated with their addresses where

each bit represents a right in the system. The DENY_MASK defined the mask

used to identify if the denied bit is on, preventing users from interacting
